...
function ENT:GetTargetA()
	...
	for k,v in pairs(ents.GetAll()) do
		if v:IsValid() && (table.HasValue(catchThem, string.lower(v:GetClass())) or v:IsNPC() or (v:IsPlayer() and !GetConVar("ai_ignoreplayers"):GetBool() and GetConVar("tnt_attack_player"):GetBool()) and v != self:GetTurretOwner()) and v != self.NPCCube then
